...
export function editUserRole(http: HttpClient, rootUrl: string, params: EditUserRole$Params, context?: HttpContext): Observable<StrictHttpResponse<UserProfileDto>> {
